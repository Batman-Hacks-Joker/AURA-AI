...
>(
  (
    ...
    // Set the default open state from cookies.
    const [defaultOpenState] = React.useState(() => {
...
>(
  (
    ...
    const handleClick = (e: React.MouseEvent<HTMLDivElement>) => {
      if (state === 'collapsed') {
          // Check if the click is on the sidebar itself and not on a button or link
