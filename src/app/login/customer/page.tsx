      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <Card>
          <CardHeader className="text-center">
            <CardTitle className="font-headline text-2xl">Customer Sign In</CardTitle>
            <CardDescription>Sign in to access your AURA AI products.</CardDescription>
          </CardHeader>
            <CardContent className="space-y-4">
              <Button onClick={() => signIn(role)} className="w-full" disabled={loading}>
                <GoogleIcon />
